...
#@since 1.8.0
break に引数を指定した場合はその値がブロック付きメソッドの戻り値になります。#@end
...
イテレータを定義するために [[ref:d:spec/def#method]] 内で使用します。
        ...
        # => 13
        #    23
        #    33 (同じブロックが3つのyieldで3回起動された。        #        具体的には p 10 + 3; p 20 + 3; p 30 + 3 を実行した)
...
#@since 1.8.0
next に引数を指定した場合はその値が yield の戻り値になります。#@end
...
は現在のところ警告は出ませんが使用しない方がよいでしょう。#@#((-[[ruby-dev:20358]], [[ruby-dev:20409]]-))
#@end
...
lambda でないブロックを呼び出したとき
  ...
  * 引数の数が違ってもエラーになりません。  * 配列をひとつ渡したときにそれが引数の並びとして展開されることがあります。
