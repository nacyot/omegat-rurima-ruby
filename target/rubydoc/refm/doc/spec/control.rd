...
예:
          ...
          ARGF.each_line do |line|
            next if line.strip.empty?            print line
          end
...
#@until 1.9.1
[注意] ensure は大域脱出を補足するため、retry の例では (d) も表示されます。#@end
...
예외가 발생합니다.第一の形式では直前の例外を再発生させます。第二の形式では、引数が文字列であった場合、その文字列をメッセー
