...
#@since 2.0.0
Ruby 2.0 の組込みクラスのリファレンスはほぼ揃っています。Ruby 2.0 の標準添付ライブラリのリファレンスは一部未完成です。#@end
#@if("1.9.0" <= version and version < "2.0.0")
Ruby 1.9 の組込みクラスのリファレンスはほぼ揃っています。Ruby 1.9 の標準添付ライブラリのリファレンスは一部未完成です。#@end
#@until 1.9.0
Ruby 1.8 の組込みクラスのリファレンスは揃っています。Ruby 1.8 の標準添付ライブラリのリファレンスは一部未完成です。#@end
