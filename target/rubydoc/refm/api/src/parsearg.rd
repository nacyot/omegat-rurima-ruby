...
代わりに [[lib:optparse]] か [[lib:getoptlong]] を使ってください。#@else
...
@param opts  ロングネームのオプションや、引数を伴うオプションを文字列で指定をします。             --version や --geometry 300x400、-d host:0.0 等がこれ
             に該当します。引数を伴う指定は ":" を必ず付ける様にし
             합니다.この例の場合、"version"、"geometry:"、"d:" の様
