...
渡されるストリームオブジェクトは以下のメソッドを持っています。  * puts(str = '') strを出力して CR LFを出力
  * print(str)     strを出力
...
#@since 1.9.1
コマンドを送った後、ブロックを呼び出します。このメソッドの返り値はブロックの返り値になります。#@end
...
--- Revision -> String
ファイルのリビジョンです。사용하지 마시기 바랍니다.

#@since 1.8.7
= class Net::SMTP::Response < Object
[[c:Net::SMTP]] の内部用クラスです。#@end
