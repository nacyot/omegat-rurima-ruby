...
@param enum [[c:Enumerable]] をインクルードしたオブジェクトを与えます。            enum とブロックを同時に与えた場合は、ブロックは無視されます。
...
예:
  ...
  g = Generator.new(['A', 'B', 'C', 'Z'])
  p g.current # => 'A'p g.current # => 'A'
  p g.current # => 'A'p g.current # => 'A'

--- each {|e| ... } -> self

ジェネレータの要素を引数としてブロックを評価します。self를 리턴합니다.
...
与えられた Enumerable オブジェクトの数を返します。#@end
