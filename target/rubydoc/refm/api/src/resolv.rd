...
#@else
@param resolv_conf DNSの設定を与えます。#@end
...
typeclass は以下のいずれかです。  * [[c:Resolv::DNS::Resource::IN::ANY]]
...
#@# @param msg DNSサーバからの返答を与えます。[[c:Resolv::DNS::Message]] のインスタンスを与えることができます。#@# @param name フィルタリングする名前を指定します。#@# @param typeclass フィルタリングするDNSレコード種別を表します。[[m:Resolv::DNS#getresource]] の typeclass と同じクラスを与えます。#@# --- lazy_initialize -> Resolv::DNS
...
#@# #@until 1.8.5
#@# Resolv::DNS内部で利用される [[c:ThreadGroup]] です。#@# #@else
#@# この定数はもはや利用されていません。#@# #@end
...
#@# このモジュールはユーザが使うべきではありません。#@# == Constants
#@# 
#@# --- Query
#@# #@todo
#@# 
...
#@# このクラスはユーザが使うべきではありません。#@# == Class Method
#@# 
...
#@# ドメイン名を取り扱うためのユーティリティモジュールです。#@# [[c:Resolv::DNS::Name]] から使われます。#@# 
#@# == Class Methods
#@# 
