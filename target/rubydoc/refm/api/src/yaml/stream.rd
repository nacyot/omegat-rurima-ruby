...
#@since 1.9.2
            [[m:Syck::DEFAULTS]] を参照してください。#@else
            [[m:YAML::DEFAULTS]] を参照してください。#@end
...
@param i 参照したいドキュメントの番号を指定します。
  ...
  begin
    ...
    p $!    #=> #<NoMethodError: undefined method `[]=' for #<YAML::Stream:0x2b07d48 @documents=[], @options={}>>
  end
...
#@since 1.9.2
           ンは [[m:Syck::DEFAULTS]] を参照してください。#@else
           ンは [[m:YAML::DEFAULTS]] を参照してください。#@end
