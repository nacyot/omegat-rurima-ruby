...
#@since 1.9.2
@param basedir ベースディレクトリを指定します。省略するとカレントディレクトリになります。#@end
#@until 1.8.5
@param force_absolute 真の場合、絶対パスを返します。self が相対パスであれば、カレントディレクトリからの相対パスとして解釈されます。                      古い挙動は obsolete です。引数は省略すべきです。#@end
...
#@since 1.8.1
このメソッドは obsolete です。代わりに [[m:Pathname#each_line]] を使ってください。#@end
...
@param pattern 패턴 문자열을 지정합니다.ワイルドカードとして `*', `?', `[]' が使用できま
...
--- chdir{|path| ... } -> object
#@since 1.8.1
このメソッドは obsolete です。代わりに [[m:Dir.chdir]] を使ってください。#@end
...
--- chroot -> 0
#@since 1.8.1
このメソッドは obsolete です。代わりに [[m:Dir.chroot]] を使ってください。#@end
...
#@since 1.8.1
このメソッドは obsolete です。代わりに [[m:Pathname#each_entry]] メソッドを使ってください。#@end
...
#@since 1.8.1
このメソッドは obsolete です。each_line か each_entry を使ってください。#@end
