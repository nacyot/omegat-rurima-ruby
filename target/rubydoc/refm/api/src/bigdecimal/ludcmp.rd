...
#@since 1.9.2
[[m:LUSolve.#lusolve]] の引数を構築するために使います。#@else
[[m:LUSolve#lusolve]] の引数を構築するために使います。#@end
...
@param a 行列を [[c:BigDecimal]] の配列で指定します。         各要素を Row-major order で並べて 1 次元の配列にし、
#@since 1.9.2
         [[m:LUSolve.#ludecomp]] で変換したものを指定します。#@else
         [[m:LUSolve#ludecomp]] で変換したものを指定します。#@end

@param b ベクトルを [[c:BigDecimal]] の配列で指定します。

#@since 1.9.2
@param ps [[m:LUSolve.#ludecomp]] の返り値を指定します。#@else
@param ps [[m:LUSolve#ludecomp]] の返り値を指定します。#@end
