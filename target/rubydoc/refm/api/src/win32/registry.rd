...
[[m:Win32::Registry.open]](self, subkey, desired, opt)와 같습니다.

--- create(subkey, desired = KEY_ALL_ACCESS, opt = REG_OPTION_RESERVED)
#@todo

[[m:Win32::Registry.create]](self, subkey, desired, opt)와 같습니다.
...
レジストリ値の型が REG_EXPAND_SZ だった場合，環境変数が置換されます。レジストリ値の型が REG_SZ, REG_EXPAND_SZ, REG_MULTI_SZ, REG_DWORD,
...
subkey はサブキーの名前を表す String です。wtime は最終更新時刻を表す FILETIME (64-bit 整数) です。(⇒[[m:Win32::Registry.wtime2time]])
...
キーが新しく作成された場合，真を返します。(⇒[[m:Win32::Registry.create]])
