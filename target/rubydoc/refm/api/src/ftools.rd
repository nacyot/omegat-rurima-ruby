...
@param files 削除するファイルを指定します。             最後の引数が文字列でない場合または真の場合、詳細を出力します。

#@since 1.8.3
@return files を返します。        最後の引数が文字列でない場合は、最後の引数は取り除かれます。#@else
@return 削除できたファイル数を返します。#@end
...
@param dirs 作成するディレクトリを指定します。             最後の引数が文字列でない場合または真の場合、詳細を出力します。
...
@param files ファイルを指定します。             最後の引数が文字列でない場合または真の場合、詳細を出力します。
