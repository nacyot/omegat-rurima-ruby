...
HTTP のステータスコード 400 Bad Request を表すクラスです。= class WEBrick::HTTPStatus::Unauthorized < WEBrick::HTTPStatus::ClientError
HTTP のステータスコード 401 Unauthorized を表すクラスです。= class WEBrick::HTTPStatus::PaymentRequired < WEBrick::HTTPStatus::ClientError
