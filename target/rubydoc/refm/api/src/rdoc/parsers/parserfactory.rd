 ...
 * top_level [[c:RDoc::TopLevel]] オブジェクトを指定します。 * file_name: file_name ファイル名を文字列で指定します。 * body: ソースコードの内容を文字列で指定します。#@since 1.9.1
 * options: [[c:RDoc::Options]] オブジェクトを指定します。#@else
 * options: [[c:Options]] オブジェクトを指定します。#@end
...
file_name を解析できるパーサのインスタンスを返します。#@since 1.9.1
見つからなかった場合は [[c:RDoc::Parser::Simple]] のインスタンスを返します。#@else
見つからなかった場合は [[c:RDoc::SimpleParser]] のインスタンスを返します。#@end
