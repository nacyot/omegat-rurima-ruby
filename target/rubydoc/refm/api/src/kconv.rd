...
Kconv.kconv(str, Kconv::UTF32)와 같습니다.
...
Kconv.kconv(str, Encoding.locale_charmap)와 같습니다.
...
#@since 1.8.2
JIS EUC SJIS 이외의 인코딩을 나타냅니다.
#@else
JIS EUC SJIS UTF8 UTF16 이외의 인코딩을 나타냅니다.
#@end
...
#@until 1.8.5
--- Iconv_EUC_JP -> Regexp
この定数は使うべきではありません。--- Iconv_Shift_JIS -> Regexp
この定数は使うべきではありません。--- Iconv_UTF8 -> Regexp
この定数は使うべきではありません。#@end
#@end
