...
ファイルやディレクトリをコピーします。
  ...
  -p          可能であればファイルの属性を保持します。  -r          再帰的にコピーします。  -v          詳細表示
...
ファイルをコピーし、その属性を設定します。
  ...
  -p          ファイルのアクセス時刻と修正時刻を保持します。  -m          chmod と同じようにファイルのパーミッションを設定します。  -v          詳細表示
...
ディレクトリを作成します。
  ...
  -p          ディレクトリが存在してもエラーになりません。              必要であれば親ディレクトリも作成します。  -v          詳細表示
