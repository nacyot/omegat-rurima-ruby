...
いて記述しています)
  ...
  * Test::Unit - Ruby용 단위 테스트 프레임 워크: [[url:http://test-unit.rubyforge.org/index.html.ja]]
#@end
...
#@else
        ...
        Finished in 0.022223 seconds.
          ...
          1)Failure!!!        test_bar(TC_Foo) [test_foo.rb:16]:
        <bar> expected but was
        <foo>
...
明示的にテストを実行することができます。#@end

=== Error 와 Failure 의 차이
 ...
 * Rubyist Magazine 0033 호 기사!test-all 병렬화: [[url:http://jp.rubyist.net/magazine/?0033-ParallelizeTestAll]]
...
: --no-gc-stress
  ...
  [[m:GC.stress]] に false を設定します。#@end
