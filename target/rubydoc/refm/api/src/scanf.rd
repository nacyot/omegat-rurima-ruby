...
@param format スキャンするフォーマットを文字列で指定します。              詳細は、[[ref:m:String#scanf#format]] を参照してください。
...
: space
 フォーマット中の空白は(0個を含む)任意の数の空白にマッチします。//emlist{
  p "a           10".scanf("%s %d")  # => ["a", 10]
  p "a10".scanf("%1s %d")            # => ["a", 10]
//}
: %%
...
#@#
#@#  a-1) could the last spec keep matching?#@#    yes: save interim results and continue (next line)
#@#
#@#b) The last attempted spec/string did not match:
#@#
#@#  b-1)are we on the next-to-last spec in the string?#@#
#@#  yes:
#@#    is fmt_string.string_left all spaces?#@#      yes: does current spec care about input space?#@#        yes: fatal failure
