...
@param hash 設定する要素とその値を指定します。       hash には [[c:Hash]] クラスのインスタンス、または配列の配列を用いることができます。@raise NoMethodError hash のキーが to_sym メソッドを持たないときに発生します。
...
自身と比較対象のオブジェクトが等しい場合に真を返します。그렇지 않은 경우엔 false를 반환합니다.
