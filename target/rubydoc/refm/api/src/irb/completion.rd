...
メソッドの候補がでます. 候補が唯一ならば完全に補完します.
  ...
  include               install_alias_method  instance_of?  initialize            install_aliases       instance_variables
...
"変数名." の後に [Tab] を押すと, そのオブジェクトのメソッド一覧がでます.
  ...
  foo.=~                  foo.id                  foo.respond_to?  foo.__id__              foo.inspect             foo.send
  foo.__send__            foo.instance_eval       foo.singleton_methods
  foo.class               foo.instance_of?foo.taint
  foo.clone               foo.instance_variables  foo.tainted?  foo.display             foo.is_a?foo.to_a
