...
@param platform_only 真を指定するとプラットフォームが一致するもののみを返します。기본 설정은 false입니다.
...
@param only_platform 真を指定するとプラットフォームが一致するもののみを返します。기본 설정은 false입니다.
...
与えられたパスがキャッシュファイルとして利用可能な場合、そのパスを返します。그렇지 않으면 nil을 리턴합니다.
