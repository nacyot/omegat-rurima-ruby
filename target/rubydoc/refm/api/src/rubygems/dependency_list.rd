...
自身に含まれる全ての [[c:Gem::Specification]] が依存関係を満たしていれば真を返します。그렇지 않은 경우엔 false를 반환합니다.

--- ok_to_remove?(full_name) -> bool

与えられた名前を持つ [[c:Gem::Specification]] を自身から削除しても OK な場合は真を返します。그렇지 않은 경우엔 false를 반환합니다.
...
#@# よくわからない。#@# [[c:Gem::Specification]] => Array of [[c:Gem::Specification]]
